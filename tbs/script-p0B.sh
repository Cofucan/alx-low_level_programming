...
# This script creates the starter files for the project: Malloc, free
...
echo "" >> README.md
echo "This is the project directory for the project tasks where we practice dynamic memory allocation with malloc and free." >> README.md
