...
# This script creates the starter files for the project: Structures, typedef
mkdir 0x0D-preprocessor
cd 0x0D-preprocessor

# Create readme file
touch README.md
echo "# C - Structures, typedef" >> README.md
echo "" >> README.md
echo "This is the project directory for the projects where we learn structures and typedef in C." >> README.md
