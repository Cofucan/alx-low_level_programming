...
* Displayed information: (no less, no more, do not include trailing whitespace)
  ...
  * Type
  * Entry point address
* Format: the same as `readelf -h` (version `__2.26.1__`)
...
**Solution:** [100-elf_header.c](https://github.com/Cofucan/alx-low_level_programming/blob/master/0x15-file_io/100-elf_header.c)

### Note

I have included a Makefile in this project for running most commands. All paths are set to the project root directory. The ELF files for testing this project are in the folder `files`. If you want to test with those ELF files, you need to move them to the root directory of the project or else you will get errors about __file not found__.
